...
- **`FacetGroup`**: `FacetItem.depth` (0 = raíz) corre la fila entera, casilla incluida, por nivel (hasta 3). Para facetas en árbol, en orden de lectura; reemplaza marcar subniveles con guiones en el `label`.
